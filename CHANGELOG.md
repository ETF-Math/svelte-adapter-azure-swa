...
- dec1cd0: dependabot(deps-dev): bump @neoconfetti/svelte from 2.2.0 to 2.2.2 in /demo in the development-dependencies group
- 5c58471: dependabot(deps-dev): bump @sveltejs/kit from 2.19.0 to 2.19.1 in the development-dependencies group across 1 directory
- 38df899: dependabot(deps-dev): bump the development-dependencies group across 2 directories with 1 update
- 7fd4155: dependabot(deps): bump esbuild from 0.25.0 to 0.25.1 in the production-dependencies group
- 8e3f4d5: dependabot(deps-dev): bump svelte from 5.22.6 to 5.23.0 in the development-dependencies group across 1 directory
- e02e063: dependabot(deps-dev): bump the development-dependencies group in /demo with 5 updates
